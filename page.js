...
const page = () => {
  ...
  return (
    <>
    <h1 className='bg-black text-white p-7  text-5xl font-bold text-center '> koustubh's Todo list</h1>
    <form  onSubmit = {submitHandler}>
      <input type='text'  className='text-2xl border-zinc-800 border-2 m-8 px-4 py-2' placeholder='ENTER TITTLE HERE '
